...
<body ng-app="pinyougou" ng-controller="itemPageController" ng-init="loadSku()">
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list customAttributeList as attr>
								<dl>
									...
									<dd><a href="javascript:;" class="selected">${attr.value}<span title="点击取消选择">&nbsp;</span>
									</a></dd>
								</dl>
							</#list>
							...
							<#list specificationItems as spec>
							    	<dl>
										...
										<#list spec.attributeValue as value>
											<dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${value}')"
												   class="{{isSelected('${spec.attributeName}','${value}') ? 'selected' : ''}}">${value}<span title="点击取消选择">&nbsp;</span>
											</a></dd>
										</#list>
                                    </dl>
							</#list>
