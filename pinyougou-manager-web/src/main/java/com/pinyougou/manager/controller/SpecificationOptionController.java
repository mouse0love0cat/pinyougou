...
public class SpecificationOptionController {
	...
	/*/**
	* @Description 根据id查询全部规格列表
	* @Author  wangyilong
	* @Date   2019/10/28 0028 上午 11:56
	* @Param  [specId]
	...
	*/
	...
	public List<TbSpecificationOption> findSpcOptionList(long specId){
		return specificationOptionService.findSpecifcationOptionList(specId);
	}
